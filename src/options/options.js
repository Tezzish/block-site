...
async function populateAccordion() {
    ...
    rules.forEach((rule, index) => {
        ...
        const reasonsText = document.createElement('li');
        reasonsText.classList.add('list-group-item');
        reasonsText.textContent = 'Reasons:';
        reasonsList.appendChild(reasonsText);
